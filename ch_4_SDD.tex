...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{itemize}
      \item \textbf{Leave Application:} \texttt{PENDING} $\leftrightarrow$ \texttt{REVIEW\_REQUESTED} $\to$ \texttt{HOD\_PENDING} $\to$
...
\begin{itemize}
    ...
    \item \textbf{Model Interaction:} BA can login and view pending LR and accept, reject, or request more info.
    \begin{itemize}
        \item If more info requested, status updates to REVIEW\_REQUESTED. Student can update and resubmit.
...
\begin{itemize}
    ...
    \item BA reviews the pending request and can accept, reject, or request more info. If accepted, forwarded to HOD for further review.
