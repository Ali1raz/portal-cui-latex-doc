...
\begin{itemize}
\item \textbf{studentGetAllAnnouncements:} Checks resolves the student's department/program from their registration number, builds a scoped Prisma clause, orders by isPinned desc and createdAt desc.
